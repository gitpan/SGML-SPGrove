...
C<SGML::SubDocEntity> objects are loaded by C<SGML::SPGrove>.  An
C<SGML::SubDocEntity> contains a subdoc entity defined in a document
instance.  Within a grove, any entity with the same name refers to the
same C<SGML::SubDocEntity> object.
