...
C<SGML::ExtEntity> objects are loaded by C<SGML::SPGrove>.  An
C<SGML::ExtEntity> contains an external entity defined in a document
instance.  Within a grove, any entity with the same name refers to the
same C<SGML::ExtEntity> object.
